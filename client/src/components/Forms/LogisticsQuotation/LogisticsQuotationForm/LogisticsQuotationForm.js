                ...
                <form onSubmit={formik.handleSubmit} className="the-logistics-quotation-form">
                    ...
                    <div className="logistics-quotation-small-inputs">
                        <div className="logistics-quotation-small-input-group">
                            ...
                            <input type="text" placeholder="What is your city..." name="fromcity" 
                                onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.fromcity} required/>
                                {formik.touched.fromcity && formik.errors.fromcity ? (
                                    <div className="error">{formik.errors.fromcity}</div>
                                ) : null}            
                        </div>
                        <div className="logistics-quotation-small-input-group">
                            <label>Country from</label>
                            <input type="text" placeholder="What is your country..." name="fromcountry" 
                                onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.fromcountry} required/>
                                {formik.touched.fromcountry && formik.errors.fromcountry ? (
                                    <div className="error">{formik.errors.fromcountry}</div>
                                ) : null}                            
                        </div>
                        <div className="logistics-quotation-small-input-group">
                            <label> Pieces </label>
                    ...
                    <div className="logistics-quotation-small-inputs">
                        ...
                        <div className="logistics-quotation-small-input-group">
                            ...
                            <input type="text" placeholder="merchandise" name="merchandise" 
                                onChange={formik.handleChange} onBlur={formik.handleBlur} value = {formik.values.merchandise} required/>
                                {formik.touched.merchandise && formik.errors.merchandise ? (
                                    <div className="error">{formik.errors.merchandise}</div>
                                ) : null}
                        </div>
                    </div>
                    ...
                    <div className="logistics-quotation-small-inputs">
                        ...
                        <div className="logistics-quotation-small-input-group">
                            ...
                            <input type="text" placeholder="Destination City here..." name="tocountry" 
                                onChange={formik.handleChange} onBlur={formik.handleBlur} value = {formik.values.tocountry} required/>
                                {formik.touched.tocountry && formik.errors.tocountry ? (
                                    <div className="error">{formik.errors.tocountry}</div>
                                ) : null}
                        </div>
                        <div className="logistics-quotation-small-input-group">
                            <label>Destination Country</label>
                            <input type="text" placeholder="Destination Country here..." name="tocity" 
                                onChange={formik.handleChange} onBlur={formik.handleBlur} value = {formik.values.tocity} required/>
                                {formik.touched.tocity && formik.errors.tocity ? (
                                    <div className="error">{formik.errors.tocity}</div>
                                ) : null}
                        </div>
                    </div>
