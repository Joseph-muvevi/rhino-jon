    ...
    return (
      <div className="medical-footer">
        <div className="medical-footer-content">
          <div className="medical-footer-top">
            <div className="medical-footer-top-left">
              <div className="medical-footer-logo">
                <img src={logo} alt="Rhino jon logo" className="f-logo"/>
                <h3 className="medical-footer-logo-text">Jon Prime Metals</h3>
              </div>
              <div className="medical-footer-left-content">
                <p className="medical-footer-social-media-txt">For more follow us on</p>
                <div className="medical-footer-social-icons">
                  <FontAwesomeIcon size="2x" icon={faFacebook} />
                  <FontAwesomeIcon size="2x" icon={faTwitter} />
                  <FontAwesomeIcon size="2x" icon={faInstagram} />
                  <FontAwesomeIcon size="2x" icon={faLinkedinIn} />
                </div>
                <div className="medical-footer-input-group">
                  <label>Subscibe to our Newsletter</label>
                  <div className="medical-footer-inputs">
            ...
            <div className="medical-footer-top-middle">
              <h3 className="medical-footer-title">Contacts</h3>
              <ul className="medical-footer-ul">
                <li className="medical-footer-li">
            ...
            <div className="medical-footer-top-right">
              <h3 className="medical-footer-title">Utility Links</h3>
              <ul className="medical-footer-ul">
                <li className="medical-footer-li">
