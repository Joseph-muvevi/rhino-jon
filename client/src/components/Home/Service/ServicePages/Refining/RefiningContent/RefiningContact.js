					...
					<div className="refinery-content-content-right">
						<div className="refinery-content-right-cards">
							<p className="refinery-content-right-cards-row">
								Gold refinery is set to be constructed in Nairobi, Kenya, 
								by end of year 2023, to offer small-scale and artisanal miners the means 
								to add value from gold extracted from mines across the East and Central 
								Africa region and get substantial incomes while trading for the international 
								market with the gold increased purity to 99.99%.
							</p>
							<p className="refinery-content-right-cards-row">
								This facility will provide additional services including but not 
								limited to recycling of scrap precious metals,  melting and conversion 
								of gold from dusts, nuggets into gold bars, precious metals quality assay 
								and minting.
							</p>
							<p className="refinery-content-right-cards-row">
								Currently, for the purpose of easy trade, we are operating a melting facility for 
								form conversion, recycling and assaying of precious metals mainly for exports.
							</p>
						...
						<div className="service-fontawesome-div">
							...
							<Link to="/services-refinery"  className="service-fontawesome-icon-card">
								<p className="service-font-awesome-card-p">
									Sea
								</p>
